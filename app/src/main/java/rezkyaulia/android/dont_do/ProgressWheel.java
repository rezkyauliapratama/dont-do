...
public class ProgressWheel extends View {
    ...
    protected void init(AttributeSet attrs, int defStyle) {
        ...
        mThickness = a.getDimensionPixelSize(R.styleable.ProgressWheel_dpv_thickness,
                resources.getDimensionPixelSize(R.dimen.default_thickness));

        mOuterCircleColor = a.getColor(R.styleable.ProgressWheel_dpv_outer_color,
                ContextCompat.getColor(getContext(), R.color.colorPrimary));

        mAnimDuration = a.getInteger(R.styleable.ProgressWheel_dpv_anim_duration,
